 ! THE BACKGROUND SOLVER. 
    ...
    MODULE BACKGROUND_PATH
     ...
     SUBROUTINE BACKGROUND_VALUE
       ...
       character(LEN=:),allocatable::OUTPUT_DIR   !! Name of output directory. Added by Ivan Debono 
  ...
  !=============================================================================== 
#ifndef MPI
  OUTPUT_DIR=Ini_Read_String('output_dir') !! Added by Ivan Debono   
  OPEN(UNIT=FILE_NUM,FILE=trim(OUTPUT_DIR)//'/EPSILON.dat',FORM='FORMATTED',STATUS='REPLACE')
#endif
...
! 
     ...
     OPEN(UNIT=FILE_NUM,FILE=trim(OUTPUT_DIR)//'/PHI.dat',FORM='FORMATTED',STATUS='REPLACE')
     OPEN(UNIT=FILE_NUM1,FILE=trim(OUTPUT_DIR)//'/DPHI_DN.dat',FORM='FORMATTED',STATUS='REPLACE')
     OPEN(UNIT=FILE_NUM2,FILE=trim(OUTPUT_DIR)//'/HUBBLE.dat',FORM='FORMATTED',STATUS='REPLACE')
     OPEN(UNIT=FILE_NUM3,FILE=trim(OUTPUT_DIR)//'/PHINN.dat',FORM='FORMATTED',STATUS='REPLACE')
